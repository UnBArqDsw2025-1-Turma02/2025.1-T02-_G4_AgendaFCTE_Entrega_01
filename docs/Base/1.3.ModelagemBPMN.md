...
**Figura 6 - BPMN Criação de eventos**
...
**Figura 7 - BPMN Inscrição de Eventos**
![SprintReview](docs\Base\assets\bpmn_jl.jpg)
...
| `1.1`  | 10/04/2025  | Adição diagrama BPMN de criação de eventos | [Alexandre Xavier](https://github.com/AlexandreLJr)  | |
