...
| -------- | ---------- | ------------------- | -- | 
| Pergunta levantada para o requisito. | A pergunta foi respondida? Sim/Não | Expecificação do requisito. | Identificação do requisito. | 
...
| `1.1`    | 10/04/2025 | Finalizando tabelas de requisitos  | [Pedro Lopes](https://github.com/pLopess) |  |