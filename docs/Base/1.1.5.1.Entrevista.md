...
Para acessar o documento completo do termo de consentimento, veja a tabela 2 abaixo.
...
As tabelas 3 e 4, apresentadas a seguir, descrevem os requisitos funcionais e também os não-funcionais que foram elicitados.
...
| Tipo | Descrição | ID   |
|------|-----------|------|
| RF1  | O aplicativo deverá permitir a visualização de eventos com informações como data, local, descrição e formas de inscrição | EN01 |
| RF2  | O aplicativo deverá permitir o filtro de eventos por tipo (tags/labels) como palestras, workshops, exposições etc. | EN02 |
| RF3  | O aplicativo deverá permitir ao usuário favoritar eventos para acompanhar novidades e receber notificações | EN03 |
| RF4  | O aplicativo deverá permitir a integração com Google Agenda e/ou Outlook para adicionar eventos à agenda pessoal | EN04 |
| RF5  | O aplicativo deverá permitir que o usuário curta, compartilhe e comente os eventos | EN05 |
| RF6  | O aplicativo deverá enviar notificações semanais com eventos relevantes para o usuário | EN06 |
| RF7  | O aplicativo deverá diferenciar usuários da UnB de usuários externos, respeitando os acessos permitidos | EN07 |
| RF8  | O aplicativo deverá permitir ao usuário simular interesse por tipo de evento para personalizar sugestões | EN08 |
| RF9  | O aplicativo deverá exibir alertas sobre eventos favoritados (ex: data próxima ou vagas limitadas) | EN09 |
...
| Tipo  | Descrição | ID   |
|-------|-----------|------|
| RNF1  | O aplicativo deverá apresentar uma interface limpa, sem poluição visual, e de fácil navegação | EN10 |
| RNF2  | O aplicativo deverá ser responsivo e adaptável a diferentes dispositivos móveis | EN11 |
| RNF3  | O aplicativo deverá garantir segurança dos dados dos usuários, conforme a LGPD | EN12 |
| RNF4  | O aplicativo deverá possuir um bom desempenho, com transições suaves e sem travamentos | EN13 |
...
**Vídeo 1: Entrevista - Marcos**

<iframe width="560" height="315" src="https://www.youtube.com/embed/2keiix_6gu0" title="Entrevista Paulo Vitor - Arquitetura e Desenho de Software" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

**Vídeo 2: Entrevista - Paulo**
...
|--------|------------|-----------------------|-----------------------------------------------|---------------------------------------------|
| `1.0`    | 06/04/2025 | Estruturação Inicial  | [Thales Euflauzino](https://github.com/thaleseuflauzino) |  |
| `1.1`    | 06/04/2025 | Preenchimento dos dados obtidos  | [Thales Euflauzino](https://github.com/thaleseuflauzino) |  |
