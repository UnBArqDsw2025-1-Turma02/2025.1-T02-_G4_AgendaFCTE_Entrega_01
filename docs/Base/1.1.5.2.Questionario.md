...
> **QNx**: Requisito da entrevista número x;
...
| Tipo  | Descrição                                                                                         | ID |
|-------|---------------------------------------------------------------------------------------------------|--------------------|
| RF01  | Mostrar eventos com data, hora, local, descrição, link de inscrição e contato.                   | QS01               |
| RF02  | Permitir que usuários favoritem eventos.                                                         | QS02               |
| RF03  | Permitir que usuários sugiram novos eventos.                                                     | QS03               |
| RF04  | Permitir que usuários comentem e avaliem eventos.                                                | QS04               |
| RF05  | Permitir pesquisar eventos por nome.                                                             | QS05               |
| RF06  | Permitir requisitar participação em eventos (ex: tocar em sarau).                                | QS06               |
| RF07  | Exibir fotos ou vídeos de edições anteriores dos eventos.                                        | QS07               |
| RF08  | Permitir filtrar eventos por tipo, data, localização e/ou categoria.                             | QS08               |
| RF09  | Permitir organizar eventos por data, categoria e local.                                          | QS09               |
| RF10  | Enviar notificações por e-mail sobre eventos de interesse.                                       | QS10               |
| RF11  | Enviar notificações via WhatsApp ou outras redes sociais.                                        | QS11               |
| RF12  | Enviar notificações pelo aplicativo (push notification).                                         | QS12               |
| RF13  | Possibilitar compartilhamento de eventos em redes sociais.                                       | QS13               |
| RF14  | Integrar com canais como Instagram, WhatsApp, e-mails e murais da FGA.                           | QS14               |
| RF15  | Deve permitir a criação de fóruns para conversas, dúvidas e comentários entre usuários.          | QS15               |
...
| Tipo   | Descrição                                                                                      | ID |
|--------|------------------------------------------------------------------------------------------------|--------------------|
| RNF01  | O sistema deve ser intuitivo e fácil de usar.                                                  | QS16               |
| RNF02  | O sistema deve ser multiplataforma (desktop, mobile, tablet).                                  | QS17               |
| RNF03  | O carregamento da agenda e eventos deve ser rápido e leve.                                     | QS18               |
| RNF04  | O design deve ser atrativo e moderno, adaptado à identidade da FCTE.                           | QS19               |
| RNF05  | O sistema deve permitir fácil manutenção e atualização dos eventos pelos organizadores.        | QS20               |
| RNF06  | Deve garantir confiabilidade nas informações exibidas.                                         | QS21               |
| RNF07  | O sistema deve ter boa escalabilidade conforme a demanda.                                      | QS22               |
| RNF08  | O sistema deve enviar notificações de forma automática, conforme a preferência do usuário.     | QS23               |
...
| `1.4`    | 06/04/2025 | Adição das tabelas de requisitos funcionais e não funcionais  | [Manoela Garcia](https://github.com/manu-sgc) |  |
| `1.5`    | 06/04/2025 | Correções nas autorias | [Victor Hugo Bernardes](https://github.com/VHbernardes) |  |