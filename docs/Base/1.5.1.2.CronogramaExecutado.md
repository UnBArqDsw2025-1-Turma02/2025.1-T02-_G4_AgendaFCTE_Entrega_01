...
<div>
  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        <td><a href="#/./Base/1.5.1.2.CronogramaExecutado?id=perfil-usuario-cron">Perfil de Usuário</a></td>
        <td colspan="5"><center>-</center></td>
      </tr>
      <tr>
        <td><a href="#/./Base/1.5.1.2.CronogramaExecutado?id=questionario">Elicitação Questionário</a></td>
        <td colspan="5"><center>-</center></td>
      </tr>
      <tr>
        <td><a href="#/./Base/1.5.1.2.CronogramaExecutado?id=entrevista">Elicitação Entrevista</a></td>
        <td colspan="5"><center>-</center></td>
      </tr>
    </tbody>
  </table>
...
| `1.3` | 07/04/2025  | Colocando as elicitações no Unpack e nas iniciativas extras | [Manoela Garcia](https://github.com/manu-sgc) | [Víctor Schmidt](https://github.com/moonshinerd) |
| `1.4` | 07/04/2025  | Ajustes nas colunas de Início, Entrega e Período de Revisão | [Manoela Garcia](https://github.com/manu-sgc) | [Víctor Schmidt](https://github.com/moonshinerd) |
