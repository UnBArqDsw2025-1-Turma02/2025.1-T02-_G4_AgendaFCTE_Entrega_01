...
- **Registro e Priorização:**  
  Documentar todas as ideias e aplicar técnicas de priorização (como a distribuição de recursos fictícios) para identificar as contribuições mais relevantes ([Wigers & Beatty, 2012](#ref3)).
